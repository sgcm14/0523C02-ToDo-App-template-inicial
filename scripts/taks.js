...
window.addEventListener("load", function () {
  ...
  function botonesCambioEstado() {
    ...
    btnsCambioEstado.forEach((boton) => {
      ...
      boton.addEventListener("click", (e) => {
        ...
        fetch(urlTareaUpdate, settings).then((response) => {
  ...
  function botonBorrarTarea() {
    const btnsBorrarTarea = document.querySelectorAll(".borrar");

    btnsBorrarTarea.forEach((boton) => {
      boton.addEventListener("click", (e) => {
  ...
  function eliminarTarea(id) {
    const urlTareaEliminar = `${urlTareas}/${id}`;
    ...
    fetch(urlTareaEliminar, settings)
      .then((response) => {
        console.log(response);
        ...
        response.json().then((resp) => {
          if (resp) {
            ...
            alert("La tarea se ha eliminado correctamente :D");
          }
        });
        consultarTareas();
      })
